...
export class UserGuard implements CanActivate {
  ...
  canActivate(
    ...
    if (this.loginService.isLoggedIn() && this.loginService.getUserRole() === 'USER') {        // Verifica se o usuário está logado e se o seu papel é 'USER'.
...
/* Esse guard tem como finalidade decidir se a rota pode ser ativada ou não. O UserGuard verifica se o usuário está logado e se possui o papel 
de "USER". Se ambas as condições forem verdadeiras, ele permite o acesso à rota protegida. Caso contrário, ele redireciona o usuário para a 
página de login. */